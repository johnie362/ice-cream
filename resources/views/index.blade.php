...
<nav class="navbar navbar-dark bg-dark">
    ...
    <span class="navbar-brand mb-0 h1">PHOEBE'S ICECREAM SHOP 🎂🌹</span>
</nav>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <input type="number" style="color: rgb(0, 26, 255); background: black; font-size: 30px;" id="qty" name="qty" placeholder="Qty" required>
                </div>
            </div>
